...
public class HighwayBuilderHIG extends Module {
    ...
    private boolean displayInfo, warned, sentLagMessage;
    ...
    private boolean canPlace(MBlockPos pos, boolean liquids) {
        if (pos.getBlockPos().distToCenterSqr(mc.player.getEyePosition()) > placeRange.get() * placeRange.get()) return false;
    ...
    private enum State {
        ...
        ReLevel {
            ...
            protected void tick(HighwayBuilderHIG b) {
                ...
                if (BlockUtils.place(pos.immutable(), InteractionHand.MAIN_HAND, slot, b.rotation.get().place, 100, true, true, false)) {
                    if (b.renderPlace.get()) RenderUtils.renderTickingBlock(pos.immutable(), b.renderPlaceSideColor.get(), b.renderPlaceLineColor.get(), b.renderPlaceShape.get(), 0, 5, true, false);
            ...
            protected void tick(HighwayBuilderHIG b) {
                ...
                if (blockState.getBlock() == Blocks.ENDER_CHEST) {
                    ...
                    if (!EChestMemory.isKnown()) {
                        ...
                        else b.mc.gameMode.useItemOn(b.mc.player, InteractionHand.MAIN_HAND, new BlockHitResult(Vec3.atCenterOf(bp), Direction.UP, bp, false));
        ...
        Restock {
            ...
            private boolean restockItems(HighwayBuilderHIG b, Container inv) {
                if (b.restockTask.materials) {
                    // take raw material
        ...
        DefuseCrystalTraps {
             ...
             * canceled by default within the handleKeybinds method if you do not have the use key held down,
        ...
        protected void mine(HighwayBuilderHIG b, MBPIterator it, boolean mineBlocksToPlace, State nextState, State lastState) {
